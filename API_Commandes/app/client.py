...
class APICommande:
    ...
    def get(self, endpoint, params=None):
        return requests.get(self._make_url(endpoint), headers=self.headers, params=params)

    def post(self, endpoint, json=None, data=None):
        return requests.post(self._make_url(endpoint), headers=self.headers, json=json, data=data)

    def put(self, endpoint, json=None, data=None):
        return requests.put(self._make_url(endpoint), headers=self.headers, json=json, data=data)

    def delete(self, endpoint):
        return requests.delete(self._make_url(endpoint), headers=self.headers)